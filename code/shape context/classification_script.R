...
colnames(punt_return_categories_index)[3] <- "event"
allclassifications <- rbind(punt_blocked_events_index, punt_downed_events_index, punt_fair_catch_events_index, punt_touchback_events_index, punt_return_categories_index)

write.csv(allclassifications, "C:/Users/Jay Sagrolikar/punting_analysis/data/resultsandids.csv", row.names = FALSE)