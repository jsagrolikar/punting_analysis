...
punter_loc_info_df <- data.frame(playId=punter_df$playId, gameId=punter_df$gameId, punting_team=punter_df$team, punter_x=punter_df$x, punter_y=punter_df$y)
...
punt_blocked_events_frame_df$adj_x <- punt_blocked_events_frame_df$x-punt_blocked_events_frame_df$
...
other_receiving_players_df <- spec_punt_receiving_df[-1,]
